...
const Int_t nPols = 6;
TString polNames0[nPols] = {"Pol0", "Asym0", "Asym0LasOff1", "Asym0LasOff2", "BackSubAsym0LasOn", "BackSubSum0"};
Bool_t pol0Pcts[nPols] = {true, true, true, true, false, false};
Float_t pol0Mults[nPols] = {100.0, 1000.0, 1000.0, 1000.0, 1000.0, 1.0};
...
TString polNames4[nPols] = {"Pol4", "Asym4", "Asym4LasOff1", "Asym4LasOff2", "BackSubAsym4LasOn", "BackSubSum4"};
Bool_t pol4Pcts[nPols] = {true, true, true, true, false, false};
Float_t pol4Mults[nPols] = {100.0, 1000.0, 1000.0, 1000.0, 1000.0, 1.0};
