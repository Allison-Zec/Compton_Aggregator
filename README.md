Aggregator for compton runs. Runs must be grouped into snails. Code does NOT work without functional CompMon install and environment variables set properly.
